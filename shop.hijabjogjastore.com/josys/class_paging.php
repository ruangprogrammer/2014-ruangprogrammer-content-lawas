...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<li><a href=category-brand-page-$prev.html>&lsaquo;</a></li>";
}
/*else{ 
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<li><a href=category-brand-page-$i.html>$i</a></li>";
  }
	  $angka .= " <li class='active'><a href=''>$halaman_aktif</a></li>";
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <li><a href=category-brand-page-$next.html>&rsaquo;</a></li>";
}
/*else{
